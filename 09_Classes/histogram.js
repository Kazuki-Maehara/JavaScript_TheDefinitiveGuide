/**
* A Set-like class that keeps track of how many times a value has been added.
* Call add() and remove() like you would for a Set, and
* call count() to find out how many times a given value has been added.
* The default iterator yields the values that have been added at least once.
* Use entries() if you want to iterate [value, count] pairs.
**/
class Histogram {
  ...
  // if the key does not appear in the key.
